...
calculate_button = customtkinter.CTkButton(app,command=calculate_bmi,font=font2,text_color='#fff',text='Calculate BMI',fg_color='#06911f',bg_color='#000',corner_radius=5,cursor='hand2',width=200)
